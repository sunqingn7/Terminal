...
#include <memory>
#include "../../../../3rdparty/qtermwidget/lib/kptyprocess.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_KPtyProcess_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_KPtyProcess_t qt_meta_stringdata_KPtyProcess = {
    {
        QT_MOC_LITERAL(0, 11)   // "KPtyProcess"
    },
    "KPtyProcess"
};
...
Q_CONSTINIT static const uint qt_meta_data_KPtyProcess[] = {
...
Q_CONSTINIT const QMetaObject KPtyProcess::staticMetaObject = { {
    QMetaObject::SuperData::link<KProcess::staticMetaObject>(),
    qt_meta_stringdata_KPtyProcess.offsetsAndSizes,
    qt_meta_data_KPtyProcess,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_KPtyProcess_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<KPtyProcess, std::true_type>
    >,
    nullptr
} };
