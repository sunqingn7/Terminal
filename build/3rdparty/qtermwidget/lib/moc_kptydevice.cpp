...
#include <memory>
#include "../../../../3rdparty/qtermwidget/lib/kptydevice.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_KPtyDevice_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_KPtyDevice_t qt_meta_stringdata_KPtyDevice = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_KPtyDevice[] = {
...
Q_CONSTINIT const QMetaObject KPtyDevice::staticMetaObject = { {
    QMetaObject::SuperData::link<QIODevice::staticMetaObject>(),
    qt_meta_stringdata_KPtyDevice.offsetsAndSizes,
    qt_meta_data_KPtyDevice,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_KPtyDevice_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<KPtyDevice, std::true_type>,
        // method 'readEof'
...
void KPtyDevice::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &KPtyDevice::readEof; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
